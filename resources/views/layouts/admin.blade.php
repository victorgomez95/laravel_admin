  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header" >
        ...
        <!-- Logo -->
        <a href="index2.html" class="logo" style="background: #014AB6;color: white">
          <!-- mini logo for sidebar mini 50x50 pixels -->
          <span class="logo-mini"><b>Exa</b>m</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Ejemplo</b></span>
        </a>

        <!-- Header Navbar: style can be found in header.less -->
        <nav class="navbar navbar-static-top" role="navigation" style="background: #014AB6;color: white">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Víctor Gómez</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="{{url('/logout')}}" class="btn btn-primary btn-flat">Cerrar</a>
                    </div>
                  </li>
                </ul>
              </li>
